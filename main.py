...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage('img/add.png')
        ...
        self.update_img = tk.PhotoImage('./img/update.png')# file=
        ...
        self.delete_img = tk.PhotoImage('./img/delete.png')
        ...
        # кнопка поиска
        self.search_img = tk.PhotoImage('./img/search.png')
